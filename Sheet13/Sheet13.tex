...
%\end{multline*}
%
%In our case, we have $K_1 = \Q(\sqrt 6)$ and $K_2 = \Q(\sqrt 7)$, and going through the
%different cases we find 
%\begin{equation*}
%    \zeta_\Q \zeta_{K_1} \zeta_{K_2}(s) = 
%    \zeta^2(s) \left(\frac 1{1-3^{-s}} \right)^2 
%\end{equation*}
%
